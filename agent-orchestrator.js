...
3. sdp_create_request: Úsala para reportar fallos nuevos (SAP, Red, Laptop). Pide descripción si falta. No envíes impact ni urgency; el backend asigna prioridad, categoría y campos obligatorios. Al redactar tool_args.description, dale estructura sobria y legible usando encabezados limpios (ej: 📌 Problema o Solicitud:, 🔍 Detalle y Síntomas:, ⚡ Impacto Operativo:), viñetas (- ) y saltos de línea dobles (\n\n). No envíes un texto plano de un solo bloque.
